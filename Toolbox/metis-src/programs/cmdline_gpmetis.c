 ...
 *-------------------------------------------------------------------*/
static struct gk_option long_options[] = {{"ptype", 1, 0, METIS_OPTION_PTYPE}, {"objtype", 1, 0, METIS_OPTION_OBJTYPE},
...
/*  {"balanced",       0,      0,      METIS_OPTION_BALANCE}, */
                                          ...
                                          {"ufactor", 1, 0, METIS_OPTION_UFACTOR}, {"niter", 1, 0, METIS_OPTION_NITER},
                                          {"ncuts", 1, 0, METIS_OPTION_NCUTS},

                                          {"tpwgts", 1, 0, METIS_OPTION_TPWGTS}, {"ubvec", 1, 0, METIS_OPTION_UBVEC},
...
static gk_StringMap_t rtype_options[] = {{"fm", METIS_RTYPE_FM}, {"greedy", METIS_RTYPE_GREEDY}, {NULL, 0}};

/*-------------------------------------------------------------------
 * Mini help
 *-------------------------------------------------------------------*/
static char helpstr[][100] = {" ", "Usage: gpmetis [options] graphfile nparts", " ", " Required parameters",
...
" ",
*/
                              "  -no2hop", "     Specifies that the coarsening will not perform any 2-hop matchings",
                              ...
                              "     If supplied, this parameter takes priority over ufactor.", " ", "  -niter=int",
...
*/
                              ...
                              "  -dbglvl=int      ", "     Selects the dbglvl.  ", " ", "  -help",
                              "     Prints this message.", ""};

static char shorthelpstr[][100] = {" ", "   Usage: gpmetis [options] <filename> <nparts>",
