...
METIS_API(int) METIS_PartGraphKway(idx_t* nvtxs,
                                   idx_t* ncon,
                                   idx_t* xadj,
                                   idx_t* adjncy,
                                   idx_t* vwgt,
...
METIS_API(int) METIS_MeshToDual(idx_t* ne,
                                idx_t* nn,
                                idx_t* eptr,
                                idx_t* eind,
                                idx_t* ncommon,
...
METIS_API(int) METIS_MeshToNodal(idx_t* ne,
                                 idx_t* nn,
                                 idx_t* eptr,
                                 idx_t* eind,
                                 idx_t* numflag,
...
METIS_API(int) METIS_PartMeshNodal(idx_t* ne,
                                   idx_t* nn,
                                   idx_t* eptr,
                                   idx_t* eind,
                                   idx_t* vwgt,
...
METIS_API(int) METIS_PartMeshDual(idx_t* ne,
                                  idx_t* nn,
                                  idx_t* eptr,
                                  idx_t* eind,
                                  idx_t* vwgt,
...
METIS_API(int) METIS_NodeND(idx_t* nvtxs,
                            idx_t* xadj,
                            idx_t* adjncy,
                            idx_t* vwgt,
                            idx_t* options,
...
METIS_API(int) METIS_NodeNDP(idx_t nvtxs,
                             idx_t* xadj,
                             idx_t* adjncy,
                             idx_t* vwgt,
                             idx_t npes,
...
METIS_API(int) METIS_ComputeVertexSeparator(idx_t* nvtxs,
                                            idx_t* xadj,
                                            idx_t* adjncy,
                                            idx_t* vwgt,
                                            idx_t* options,
...
METIS_API(int) METIS_NodeRefine(idx_t nvtxs,
                                idx_t* xadj,
                                idx_t* vwgt,
                                idx_t* adjncy,
                                idx_t* where,
...
typedef enum {
  METIS_OP_PMETIS, METIS_OP_KMETIS, METIS_OP_OMETIS
} moptype_et;
...
typedef enum {
  METIS_GTYPE_DUAL, METIS_GTYPE_NODAL
} mgtype_et;
...
typedef enum {
  METIS_IPTYPE_GROW, METIS_IPTYPE_RANDOM, METIS_IPTYPE_EDGE, METIS_IPTYPE_NODE, METIS_IPTYPE_METISRB
} miptype_et;

/*! Refinement schemes */
typedef enum {
  METIS_RTYPE_FM, METIS_RTYPE_GREEDY, METIS_RTYPE_SEP2SIDED, METIS_RTYPE_SEP1SIDED
} mrtype_et;
...
/* Types of objectives */
typedef enum {
  METIS_OBJTYPE_CUT, METIS_OBJTYPE_VOL, METIS_OBJTYPE_NODE
} mobjtype_et;
