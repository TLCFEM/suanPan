        ...
        *******************************************************/
        ...
        for (nswaps = 0; nswaps < nvtxs; nswaps++) {
            ...
            if(pwgts[2] < mincut || (pwgts[2] == mincut && newdiff < mindiff)) {
                ...
                if(nswaps - mincutorder > 2 * limit || (nswaps - mincutorder > limit && pwgts[2] > 1.10 * mincut)) {
                    pwgts[2] += (vwgt[higain] - rinfo[higain].edegrees[other]);
        ...
        *******************************************************/
        ...
        for (nswaps = 0; nswaps < nvtxs; nswaps++) {
            ...
            if(pwgts[2] < mincut || (pwgts[2] == mincut && newdiff < mindiff)) {
                ...
                if(nswaps - mincutorder > 3 * limit || (nswaps - mincutorder > limit && pwgts[2] > 1.10 * mincut)) {
                    pwgts[2] += (vwgt[higain] - rinfo[higain].edegrees[other]);
                    break; /* No further improvement, break out */
                }
            }
            ...
            ***********************************************************/
            ...
            IFSET(ctrl->dbglvl,
                  ...
                  printf("Moved %6"PRIDX" to %3"PRIDX", Gain: %5"PRIDX" [%5"PRIDX"] \t[%5"PRIDX" %5"PRIDX" %5"PRIDX"] [%3"PRIDX" %2"PRIDX"]\n", higain, to, (
                      vwgt[higain]
                          - rinfo[higain].edegrees[other]), vwgt[higain], pwgts[0], pwgts[1], pwgts[2], nswaps, limit));
        }
