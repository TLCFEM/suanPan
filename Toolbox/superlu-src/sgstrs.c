...
void sgstrs(trans_t trans, SuperMatrix* L, SuperMatrix* U, const int* perm_c, const int* perm_r, SuperMatrix* B, SuperLUStat_t* stat, int* info) {
#ifdef _CRAY
        ...
        for(k = 0; k <= Lstore->nsuper; k++) {
            ...
            if(nsupc == 1) {
                ...
                for(j = 0; j < nrhs; j++) {
                    ...
                    smatvec(nsupr, nrow, nsupc, &Lval[luptr + nsupc], &rhs_work[fsupc], &work[0]);
