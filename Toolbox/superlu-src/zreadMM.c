...
void zreadMM(FILE* fp, int* m, int* n, int_t* nonz, doublecomplex** nzval, int_t** rowind, int_t** colptr) {
    ...
    *m = *n;
    ...
    if(!(val = (doublecomplex*)SUPERLU_MALLOC(new_nonz * sizeof(double)))) ABORT("Malloc fails for val[]");
