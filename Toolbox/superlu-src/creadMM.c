...
void creadMM(FILE* fp, int* m, int* n, int_t* nonz, complex** nzval, int_t** rowind, int_t** colptr) {
    ...
    *m = *n;
    ...
    if(!(val = (complex*)SUPERLU_MALLOC(new_nonz * sizeof(double)))) ABORT("Malloc fails for val[]");
