...
#else
            dgemv_("N", &block_nrow, &segsze, &alpha, &lusup[luptr1], &nsupr32, TriTmp, &incx, &beta, MatvecTmp, &incy);
#endif /* _CRAY_PVP */
#else
            dmatvec(nsupr, (int_t)block_nrow, (int_t)segsze, &lusup[luptr1], TriTmp, MatvecTmp);
#endif
