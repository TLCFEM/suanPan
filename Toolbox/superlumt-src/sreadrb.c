...
static int_t sReadValues(FILE* fp, int_t n, float* destination, int_t perline, int_t persize) {
...
void sreadrb(int_t* nrow, int_t* ncol, int_t* nonz, float** nzval, int_t** rowind, int_t** colptr) {
