...
/* ----------------
   Driver routines 
   ---------------*/
extern void pcgssv(int_t, SuperMatrix*, int_t*, int_t*, SuperMatrix*, SuperMatrix*,
                   SuperMatrix*, int_t*);
extern void pcgssvx(int_t, superlumt_options_t*, SuperMatrix*, int_t*, int_t*,
...
extern void cCreate_CompCol_Matrix(SuperMatrix*, int_t, int_t, int_t, complex*,
                                   int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
void cCreate_CompCol_Permuted(SuperMatrix*, int_t, int_t, int_t, complex*, int_t*,
                              int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void cCopy_CompCol_Matrix(SuperMatrix*, SuperMatrix*);
extern void cCreate_Dense_Matrix(SuperMatrix*, int_t, int_t, complex*, int_t,
                                 Stype_t, Dtype_t, Mtype_t);
extern void cCreate_SuperNode_Matrix(SuperMatrix*, int_t, int_t, int_t, complex*, int_t*, int_t*,
                                     int_t*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void cCreate_SuperNode_Permuted(SuperMatrix*, int_t, int_t, int_t, complex*,
                                       int_t*, int_t*, int_t*, int_t*, int_t*, int_t*,
                                       int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void cCopy_Dense_Matrix(int_t, int_t, complex*, int_t, complex*, int_t);
...
extern pcgstrf_threadarg_t* pcgstrf_thread_init(SuperMatrix*, SuperMatrix*, SuperMatrix*,
                                                superlumt_options_t*, pxgstrf_shared_t*, Gstat_t*, int_t*);
extern void pcgstrf_thread_finalize(pcgstrf_threadarg_t*, pxgstrf_shared_t*,
...
extern void pcgstrf_relax_snode(const int_t, superlumt_options_t*,
                                pxgstrf_relax_t*);
extern int_t pcgstrf_factor_snode(const int_t, const int_t, SuperMatrix*, const float,
