...
/* Subroutine */ int_t genmmd_(int_t* neqns, int_t* xadj, shortint* adjncy, shortint* invp, shortint* perm, int_t* delta, shortint* dhead, shortint* qsize, shortint* llist, shortint* marker, int_t* maxint, int_t* nofsub) {
    /* System generated locals */
    int_t i__1;

    /* Local variables */
    static int_t mdeg, ehead, i, mdlmt, mdnode;
    extern /* Subroutine */ int_t mmdelm_(int_t*, int_t*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, int_t*, int_t*), mmdupd_(int_t*, int_t*, int_t*, shortint*, int_t*, int_t*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, int_t*, int_t*), mmdint_(int_t*, int_t*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*, shortint*),
    ...
    /*        ------------------------------------------------ */
    *nofsub = 0;
    mmdint_(neqns, &xadj[1], &adjncy[1], &dhead[1], &invp[1], &perm[1], &qsize[1], &llist[1], &marker[1]);
...
L800:
    mmdelm_(&mdnode, &xadj[1], &adjncy[1], &dhead[1], &invp[1], &perm[1], &qsize[1], &llist[1], &marker[1], maxint, &tag);
    num += qsize[mdnode];
    llist[mdnode] = ehead;
    ehead = mdnode;
    if(*delta >= 0) {
...
L900:
    ...
    mmdupd_(&ehead, neqns, &xadj[1], &adjncy[1], delta, &mdeg, &dhead[1], &invp[1], &perm[1], &qsize[1], &llist[1], &marker[1], maxint, &tag);
    goto L300;
...
/* Subroutine */ int_t mmdint_(int_t* neqns, int_t* xadj, shortint* adjncy, shortint* dhead, shortint* dforw, shortint* dbakw, shortint* qsize, shortint* llist, shortint* marker) {
    /* System generated locals */
    int_t i__1;
...
/* Subroutine */ int_t mmdelm_(int_t* mdnode, int_t* xadj, shortint* adjncy, shortint* dhead, shortint* dforw, shortint* dbakw, shortint* qsize, shortint* llist, shortint* marker, int_t* maxint, int_t* tag) {
    /* System generated locals */
    int_t i__1, i__2;
...
/* Subroutine */ int_t mmdupd_(int_t* ehead, int_t* neqns, int_t* xadj, shortint* adjncy, int_t* delta, int_t* mdeg, shortint* dhead, shortint* dforw, shortint* dbakw, shortint* qsize, shortint* llist, shortint* marker, int_t* maxint, int_t* tag) {
    /* System generated locals */
    int_t i__1, i__2;
...
/* Subroutine */ int_t mmdnum_(int_t* neqns, shortint* perm, shortint* invp, shortint* qsize) {
    /* System generated locals */
    int_t i__1;
