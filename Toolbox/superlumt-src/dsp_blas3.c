...
int_t sp_dgemm(char* trans, int_t m, int_t n, int_t k,
               double alpha, SuperMatrix* A, double* b, int_t ldb,
	...
	*/
	...
	for(j = 0; j < n; ++j) { sp_dgemv(trans, alpha, A, &b[ldb * j], incx, beta, &c[ldc * j], incy); }
	return 0;
}
