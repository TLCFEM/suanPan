...
/* ----------------
   Driver routines 
   ---------------*/
extern void pdgssv(int_t, SuperMatrix*, int_t*, int_t*, SuperMatrix*, SuperMatrix*,
                   SuperMatrix*, int_t*);
extern void pdgssvx(int_t, superlumt_options_t*, SuperMatrix*, int_t*, int_t*,
...
void dCreate_CompCol_Permuted(SuperMatrix*, int_t, int_t, int_t, double*, int_t*,
                              int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
...
extern void dCreate_SuperNode_Matrix(SuperMatrix*, int_t, int_t, int_t, double*, int_t*, int_t*,
                                     int_t*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void dCreate_SuperNode_Permuted(SuperMatrix*, int_t, int_t, int_t, double*,
...
extern pdgstrf_threadarg_t* pdgstrf_thread_init(SuperMatrix*, SuperMatrix*, SuperMatrix*,
...
extern void pdgstrf_relax_snode(const int_t, superlumt_options_t*,
                                pxgstrf_relax_t*);
extern int_t pdgstrf_factor_snode(const int_t, const int_t, SuperMatrix*, const double,
