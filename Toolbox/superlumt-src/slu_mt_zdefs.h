...
/* ----------------
   Driver routines 
   ---------------*/
extern void pzgssv(int_t, SuperMatrix*, int_t*, int_t*, SuperMatrix*, SuperMatrix*,
                   SuperMatrix*, int_t*);
extern void pzgssvx(int_t, superlumt_options_t*, SuperMatrix*, int_t*, int_t*,
...
extern void zCreate_CompCol_Matrix(SuperMatrix*, int_t, int_t, int_t, doublecomplex*,
                                   int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
void zCreate_CompCol_Permuted(SuperMatrix*, int_t, int_t, int_t, doublecomplex*, int_t*,
                              int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void zCopy_CompCol_Matrix(SuperMatrix*, SuperMatrix*);
extern void zCreate_Dense_Matrix(SuperMatrix*, int_t, int_t, doublecomplex*, int_t,
                                 Stype_t, Dtype_t, Mtype_t);
extern void zCreate_SuperNode_Matrix(SuperMatrix*, int_t, int_t, int_t, doublecomplex*, int_t*, int_t*,
                                     int_t*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void zCreate_SuperNode_Permuted(SuperMatrix*, int_t, int_t, int_t, doublecomplex*,
                                       int_t*, int_t*, int_t*, int_t*, int_t*, int_t*,
                                       int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void zCopy_Dense_Matrix(int_t, int_t, doublecomplex*, int_t, doublecomplex*, int_t);
...
extern pzgstrf_threadarg_t* pzgstrf_thread_init(SuperMatrix*, SuperMatrix*, SuperMatrix*,
                                                superlumt_options_t*, pxgstrf_shared_t*, Gstat_t*, int_t*);
extern void pzgstrf_thread_finalize(pzgstrf_threadarg_t*, pxgstrf_shared_t*,
...
extern void pzgstrf_relax_snode(const int_t, superlumt_options_t*,
                                pxgstrf_relax_t*);
extern int_t pzgstrf_factor_snode(const int_t, const int_t, SuperMatrix*, const double,
                                  yes_no_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*,
                                  doublecomplex*, doublecomplex*, pxgstrf_shared_t*, int_t*);
extern void pxgstrf_mark_busy_descends(int_t, int_t, int_t*, pxgstrf_shared_t*, int_t*, int_t*);
