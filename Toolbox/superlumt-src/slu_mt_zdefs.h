...
/* ----------------
   ...
   ---------------*/
extern void
pzgssv(int_t, SuperMatrix*, int_t*, int_t*, SuperMatrix*, SuperMatrix*, SuperMatrix*, int_t*);
extern void
pzgssvx(int_t, superlumt_options_t*, SuperMatrix*, int_t*, int_t*, equed_t*, double*, double*, SuperMatrix*, SuperMatrix*, SuperMatrix*, SuperMatrix*, double*, double*, double*, double*, superlu_memusage_t*, int_t*);
extern void
c_bridge_pzgssv_(int_t* nprocs, int_t* n, int_t* nnz, int_t* nrhs, doublecomplex* values, int_t* rowind, int_t* colptr, doublecomplex* b, int_t* ldb, int_t* info);

/* ---------------
   Driver related
   ---------------*/
extern void zgsequ(SuperMatrix*, double*, double*, double*, double*, double*, int_t*);
extern void zlaqgs(SuperMatrix*, double*, double*, double, double, double, equed_t*);
extern void zgscon(char*, SuperMatrix*, SuperMatrix*, double, double*, int_t*);
extern double zPivotGrowth(int_t, SuperMatrix*, int_t*, SuperMatrix*, SuperMatrix*);
extern void zgsrfs(trans_t, SuperMatrix*, SuperMatrix*, SuperMatrix*, int_t*, int_t*, equed_t, double*, double*, SuperMatrix*, SuperMatrix*, double*, double*, Gstat_t*, int_t*);
extern int_t sp_ztrsv(char*, char*, char*, SuperMatrix*, SuperMatrix*, doublecomplex*, int_t*);
extern int_t sp_zgemv(char*, doublecomplex, SuperMatrix*, doublecomplex*, int_t, doublecomplex, doublecomplex*, int_t);
extern int_t sp_zgemm(char*, int_t, int_t, int_t, doublecomplex, SuperMatrix*, doublecomplex*, int_t, doublecomplex, doublecomplex*, int_t);

/* ----------------------
   Factorization related
   ----------------------*/
extern void pxgstrf_scheduler(const int_t, const int_t, const int_t*, int_t*, int_t*, pxgstrf_shared_t*);
extern int ParallelInit(int_t, pxgstrf_relax_t*, superlumt_options_t*, pxgstrf_shared_t*);
...
extern int_t EnqueueRelaxSnode(queue_t*, int_t, pxgstrf_relax_t*, pxgstrf_shared_t*);
...
extern void
zCreate_CompCol_Matrix(SuperMatrix*, int_t, int_t, int_t, doublecomplex*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
void zCreate_CompCol_Permuted(SuperMatrix*, int_t, int_t, int_t, doublecomplex*, int_t*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void
zCopy_CompCol_Matrix(SuperMatrix*, SuperMatrix*);
extern void
zCreate_Dense_Matrix(SuperMatrix*, int_t, int_t, doublecomplex*, int_t, Stype_t, Dtype_t, Mtype_t);
extern void
zCreate_SuperNode_Matrix(SuperMatrix*, int_t, int_t, int_t, doublecomplex*, int_t*, int_t*, int_t*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void
zCreate_SuperNode_Permuted(SuperMatrix*, int_t, int_t, int_t, doublecomplex*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void
...
extern int_t zPresetMap(const int_t, SuperMatrix*, pxgstrf_relax_t*, superlumt_options_t*, GlobalLU_t*);
extern int_t qrnzcnt(int_t, int_t, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*);
extern int_t DynamicSetMap(const int_t, const int_t, const int_t, pxgstrf_shared_t*);
extern void pzgstrf(superlumt_options_t*, SuperMatrix*, int_t*, SuperMatrix*, SuperMatrix*, Gstat_t*, int_t*);
extern void pzgstrf_init(int_t, fact_t, trans_t, yes_no_t, int_t, int_t, double, yes_no_t, double, int_t*, int_t*, void*, int_t, SuperMatrix*, SuperMatrix*, superlumt_options_t*, Gstat_t*);
extern void* pzgstrf_thread(void*);
extern pzgstrf_threadarg_t*
pzgstrf_thread_init(SuperMatrix*, SuperMatrix*, SuperMatrix*, superlumt_options_t*, pxgstrf_shared_t*, Gstat_t*, int_t*);
extern void
pzgstrf_thread_finalize(pzgstrf_threadarg_t*, pxgstrf_shared_t*, SuperMatrix*, int_t*, SuperMatrix*, SuperMatrix*);
extern void pzgstrf_finalize(superlumt_options_t*, SuperMatrix*);
extern void pxgstrf_finalize(superlumt_options_t*, SuperMatrix*);
extern void pxgstrf_relax_snode(const int_t, superlumt_options_t*, pxgstrf_relax_t*);
extern int_t
pzgstrf_factor_snode(const int_t, const int_t, SuperMatrix*, const double, yes_no_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, doublecomplex*, doublecomplex*, pxgstrf_shared_t*, int_t*);
extern void
pxgstrf_mark_busy_descends(int_t, int_t, int_t*, pxgstrf_shared_t*, int_t*, int_t*);
extern int_t pzgstrf_snode_dfs(const int_t, const int_t, const int_t, const int_t*, const int_t*, const int_t*, int_t*, int_t*, int_t*, pxgstrf_shared_t*);
extern int_t pzgstrf_snode_bmod(const int_t, const int_t, const int_t, const int_t, doublecomplex*, doublecomplex*, GlobalLU_t*, Gstat_t*);
extern void pzgstrf_panel_dfs(const int_t, const int_t, const int_t, const int_t, SuperMatrix*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, doublecomplex*, GlobalLU_t*);
extern void pzgstrf_panel_bmod(const int_t, const int_t, const int_t, const int_t, const int_t, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, doublecomplex*, doublecomplex*, pxgstrf_shared_t*);
extern void pzgstrf_bmod1D(const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, int_t, int_t, int_t*, int_t*, int_t*, int_t*, doublecomplex*, doublecomplex*, GlobalLU_t*, Gstat_t*);
extern void pzgstrf_bmod2D(const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, int_t, int_t, int_t*, int_t*, int_t*, int_t*, doublecomplex*, doublecomplex*, GlobalLU_t*, Gstat_t*);
extern void pzgstrf_bmod1D_mv2(const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, int_t, int_t, int_t*, int_t*, int_t*, int_t*, doublecomplex*, doublecomplex*, GlobalLU_t*, Gstat_t*);
extern void pzgstrf_bmod2D_mv2(const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, int_t, int_t, int_t*, int_t*, int_t*, int_t*, doublecomplex*, doublecomplex*, GlobalLU_t*, Gstat_t*);
extern void pxgstrf_super_bnd_dfs(const int_t, const int_t, const int_t, const int_t, const int_t, SuperMatrix*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, pxgstrf_shared_t*);
extern int_t pzgstrf_column_dfs(const int_t, const int_t, const int_t, const int_t, int_t*, int_t*, int_t*, int_t, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, pxgstrf_shared_t*);
extern int_t pzgstrf_column_bmod(const int_t, const int_t, const int_t, const int_t, int_t*, int_t*, doublecomplex*, doublecomplex*, pxgstrf_shared_t*, Gstat_t*);
extern int_t pzgstrf_pivotL(const int_t, const int_t, const double, yes_no_t*, int_t*, int_t*, int_t*, int_t*, GlobalLU_t*, Gstat_t*);
extern int_t pzgstrf_copy_to_ucol(const int_t, const int_t, const int_t, const int_t*, const int_t*, const int_t*, doublecomplex*, pxgstrf_shared_t*);
extern void pxgstrf_pruneL(const int_t, const int_t*, const int_t, const int_t, const int_t*, const int_t*, int_t*, int_t*, GlobalLU_t*);
...
extern void zFillRHS(trans_t, int_t, doublecomplex*, int_t, SuperMatrix*, SuperMatrix*);
extern void zgstrs(trans_t, SuperMatrix*, SuperMatrix*, int_t*, int_t*, SuperMatrix*, Gstat_t*, int_t*);
...
/* ---------------
   BLAS
   ---------------*/
extern int zgemm_(char*, char*, int*, int*, int*, doublecomplex*, doublecomplex*, int*, doublecomplex*, int*, doublecomplex*, doublecomplex*, int*);
extern int ztrsm_(char*, char*, char*, char*, int*, int*, doublecomplex*, doublecomplex*, int*, doublecomplex*, int*);
...
/* ---------------
   Memory related
   ---------------*/
extern float pzgstrf_MemInit(int_t, int_t, superlumt_options_t*, SuperMatrix*, SuperMatrix*, GlobalLU_t*);
...
extern void pxgstrf_SetIWork(int_t, int_t, int_t*, int_t**, int_t**, int_t**, int_t**, int_t**, int_t**, int_t**);
...
extern int_t superlu_zQuerySpace(int_t, SuperMatrix*, SuperMatrix*, int_t, superlu_memusage_t*);
extern int_t Glu_alloc(const int_t, const int_t, const int_t, const MemType, int_t*, pxgstrf_shared_t*);
...
extern void zPrintPerf(SuperMatrix*, SuperMatrix*, superlu_memusage_t*, double, double, double*, double*, char*, Gstat_t*);
extern void zCompRow_to_CompCol(int_t m, int_t n, int_t nnz, doublecomplex* a, int_t* colind, int_t* rowptr, doublecomplex** at, int_t** rowind, int_t** colptr);
