...
void sgsrfs(trans_t trans, SuperMatrix* A, SuperMatrix* L, SuperMatrix* U, int_t* perm_r, int_t* perm_c, equed_t equed, float* R, float* C, SuperMatrix* B, SuperMatrix* X, float* ferr, float* berr, Gstat_t* Gstat, int_t* info) {
    /*
