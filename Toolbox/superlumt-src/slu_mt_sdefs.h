...
/* ----------------
   Driver routines 
   ---------------*/
extern void psgssv(int_t, SuperMatrix*, int_t*, int_t*, SuperMatrix*, SuperMatrix*,
                   SuperMatrix*, int_t*);
extern void psgssvx(int_t, superlumt_options_t*, SuperMatrix*, int_t*, int_t*,
...
extern void sCreate_CompCol_Matrix(SuperMatrix*, int_t, int_t, int_t, float*,
                                   int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
void sCreate_CompCol_Permuted(SuperMatrix*, int_t, int_t, int_t, float*, int_t*,
                              int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void sCopy_CompCol_Matrix(SuperMatrix*, SuperMatrix*);
extern void sCreate_Dense_Matrix(SuperMatrix*, int_t, int_t, float*, int_t,
                                 Stype_t, Dtype_t, Mtype_t);
extern void sCreate_SuperNode_Matrix(SuperMatrix*, int_t, int_t, int_t, float*, int_t*, int_t*,
                                     int_t*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void sCreate_SuperNode_Permuted(SuperMatrix*, int_t, int_t, int_t, float*,
                                       int_t*, int_t*, int_t*, int_t*, int_t*, int_t*,
                                       int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void sCopy_Dense_Matrix(int_t, int_t, float*, int_t, float*, int_t);
...
extern psgstrf_threadarg_t* psgstrf_thread_init(SuperMatrix*, SuperMatrix*, SuperMatrix*,
                                                superlumt_options_t*, pxgstrf_shared_t*, Gstat_t*, int_t*);
extern void psgstrf_thread_finalize(psgstrf_threadarg_t*, pxgstrf_shared_t*,
...
extern void psgstrf_relax_snode(const int_t, superlumt_options_t*,
                                pxgstrf_relax_t*);
extern int_t psgstrf_factor_snode(const int_t, const int_t, SuperMatrix*, const float,
