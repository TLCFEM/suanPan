...
/* ----------------
   ...
   ---------------*/
extern void
psgssv(int_t, SuperMatrix*, int_t*, int_t*, SuperMatrix*, SuperMatrix*, SuperMatrix*, int_t*);
extern void
psgssvx(int_t, superlumt_options_t*, SuperMatrix*, int_t*, int_t*, equed_t*, float*, float*, SuperMatrix*, SuperMatrix*, SuperMatrix*, SuperMatrix*, float*, float*, float*, float*, superlu_memusage_t*, int_t*);
extern void
c_bridge_psgssv_(int_t* nprocs, int_t* n, int_t* nnz, int_t* nrhs, float* values, int_t* rowind, int_t* colptr, float* b, int_t* ldb, int_t* info);

/* ---------------
   Driver related
   ---------------*/
extern void sgsequ(SuperMatrix*, float*, float*, float*, float*, float*, int_t*);
extern void slaqgs(SuperMatrix*, float*, float*, float, float, float, equed_t*);
extern void sgscon(char*, SuperMatrix*, SuperMatrix*, float, float*, int_t*);
extern float sPivotGrowth(int_t, SuperMatrix*, int_t*, SuperMatrix*, SuperMatrix*);
extern void sgsrfs(trans_t, SuperMatrix*, SuperMatrix*, SuperMatrix*, int_t*, int_t*, equed_t, float*, float*, SuperMatrix*, SuperMatrix*, float*, float*, Gstat_t*, int_t*);
extern int_t sp_strsv(char*, char*, char*, SuperMatrix*, SuperMatrix*, float*, int_t*);
extern int_t sp_sgemv(char*, float, SuperMatrix*, float*, int_t, float, float*, int_t);
extern int_t sp_sgemm(char*, int_t, int_t, int_t, float, SuperMatrix*, float*, int_t, float, float*, int_t);
...
extern void
sCreate_CompCol_Matrix(SuperMatrix*, int_t, int_t, int_t, float*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
void sCreate_CompCol_Permuted(SuperMatrix*, int_t, int_t, int_t, float*, int_t*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void
sCopy_CompCol_Matrix(SuperMatrix*, SuperMatrix*);
extern void
sCreate_Dense_Matrix(SuperMatrix*, int_t, int_t, float*, int_t, Stype_t, Dtype_t, Mtype_t);
extern void
sCreate_SuperNode_Matrix(SuperMatrix*, int_t, int_t, int_t, float*, int_t*, int_t*, int_t*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void
sCreate_SuperNode_Permuted(SuperMatrix*, int_t, int_t, int_t, float*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, Stype_t, Dtype_t, Mtype_t);
extern void
...
extern int_t sPresetMap(const int_t, SuperMatrix*, pxgstrf_relax_t*, superlumt_options_t*, GlobalLU_t*);
...
extern void psgstrf(superlumt_options_t*, SuperMatrix*, int_t*, SuperMatrix*, SuperMatrix*, Gstat_t*, int_t*);
extern void psgstrf_init(int_t, fact_t, trans_t, yes_no_t, int_t, int_t, float, yes_no_t, double, int_t*, int_t*, void*, int_t, SuperMatrix*, SuperMatrix*, superlumt_options_t*, Gstat_t*);
extern void* psgstrf_thread(void*);
extern psgstrf_threadarg_t*
psgstrf_thread_init(SuperMatrix*, SuperMatrix*, SuperMatrix*, superlumt_options_t*, pxgstrf_shared_t*, Gstat_t*, int_t*);
extern void
psgstrf_thread_finalize(psgstrf_threadarg_t*, pxgstrf_shared_t*, SuperMatrix*, int_t*, SuperMatrix*, SuperMatrix*);
...
extern int_t
psgstrf_factor_snode(const int_t, const int_t, SuperMatrix*, const float, yes_no_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, float*, float*, pxgstrf_shared_t*, int_t*);
extern void
pxgstrf_mark_busy_descends(int_t, int_t, int_t*, pxgstrf_shared_t*, int_t*, int_t*);
extern int_t psgstrf_snode_dfs(const int_t, const int_t, const int_t, const int_t*, const int_t*, const int_t*, int_t*, int_t*, int_t*, pxgstrf_shared_t*);
extern int_t psgstrf_snode_bmod(const int_t, const int_t, const int_t, const int_t, float*, float*, GlobalLU_t*, Gstat_t*);
extern void psgstrf_panel_dfs(const int_t, const int_t, const int_t, const int_t, SuperMatrix*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, float*, GlobalLU_t*);
extern void psgstrf_panel_bmod(const int_t, const int_t, const int_t, const int_t, const int_t, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, float*, float*, pxgstrf_shared_t*);
extern void psgstrf_bmod1D(const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, int_t, int_t, int_t*, int_t*, int_t*, int_t*, float*, float*, GlobalLU_t*, Gstat_t*);
extern void psgstrf_bmod2D(const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, int_t, int_t, int_t*, int_t*, int_t*, int_t*, float*, float*, GlobalLU_t*, Gstat_t*);
extern void psgstrf_bmod1D_mv2(const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, int_t, int_t, int_t*, int_t*, int_t*, int_t*, float*, float*, GlobalLU_t*, Gstat_t*);
extern void psgstrf_bmod2D_mv2(const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, const int_t, int_t, int_t, int_t*, int_t*, int_t*, int_t*, float*, float*, GlobalLU_t*, Gstat_t*);
...
extern int_t psgstrf_column_dfs(const int_t, const int_t, const int_t, const int_t, int_t*, int_t*, int_t*, int_t, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, int_t*, pxgstrf_shared_t*);
extern int_t psgstrf_column_bmod(const int_t, const int_t, const int_t, const int_t, int_t*, int_t*, float*, float*, pxgstrf_shared_t*, Gstat_t*);
extern int_t psgstrf_pivotL(const int_t, const int_t, const float, yes_no_t*, int_t*, int_t*, int_t*, int_t*, GlobalLU_t*, Gstat_t*);
extern int_t psgstrf_copy_to_ucol(const int_t, const int_t, const int_t, const int_t*, const int_t*, const int_t*, float*, pxgstrf_shared_t*);
...
extern void sFillRHS(trans_t, int_t, float*, int_t, SuperMatrix*, SuperMatrix*);
extern void sgstrs(trans_t, SuperMatrix*, SuperMatrix*, int_t*, int_t*, SuperMatrix*, Gstat_t*, int_t*);
...
extern int strsm_(char*, char*, char*, char*, int*, int*, float*, float*, int*, float*, int*);
...
/* ---------------
   Memory related
   ---------------*/
extern float psgstrf_MemInit(int_t, int_t, superlumt_options_t*, SuperMatrix*, SuperMatrix*, GlobalLU_t*);
...
extern int_t superlu_sQuerySpace(int_t, SuperMatrix*, SuperMatrix*, int_t, superlu_memusage_t*);
...
extern void sPrintPerf(SuperMatrix*, SuperMatrix*, superlu_memusage_t*, float, float, float*, float*, char*, Gstat_t*);
extern void sCompRow_to_CompCol(int_t m, int_t n, int_t nnz, float* a, int_t* colind, int_t* rowptr, float** at, int_t** rowind, int_t** colptr);
