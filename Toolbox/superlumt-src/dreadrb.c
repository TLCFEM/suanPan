...
static int_t dReadValues(FILE* fp, int_t n, double* destination, int_t perline, int_t persize) {
...
void dreadrb(int_t* nrow, int_t* ncol, int_t* nonz, double** nzval, int_t** rowind, int_t** colptr) {
