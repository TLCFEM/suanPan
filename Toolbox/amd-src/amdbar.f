      SUBROUTINE AMDBAR(N,PE,IW,LEN,IWLEN,PFREE,NV,NEXT,LAST,HEAD,ELEN,
     +                  DEGREE,NCMPA,W)
      IMPLICIT NONE
     ...
     +        JLAST,JNEXT,K,KNT1,KNT2,KNT3,LENJ,LN,MAXMEM,ME,MEM,MINDEG,
     +        NEL,NEWMEM,NLEFT,NVI,NVJ,NVPIV,SLENME,WE,WFLG,WNVI,X
