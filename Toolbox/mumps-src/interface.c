...
******************************************************************************/
void SPACE_numFac(factorMtx_t *L, timings_t *cpus)
{
...
******************************************************************************/
void SPACE_solve(inputMtx_t *A, FLOAT *rhs, FLOAT *xvec, options_t *options,
                 timings_t *cpus)
{
   graph_t *G;
   elimtree_t *T, *T2;
...
******************************************************************************/
void SPACE_solveWithPerm(inputMtx_t *A, PORD_INT *perm, FLOAT *rhs, FLOAT *xvec,
