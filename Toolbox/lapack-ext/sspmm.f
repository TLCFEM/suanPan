...
*
* \param[in] A
*            A is REAL(*) array of DIMENSION ((M+1)*M/2)
*
* \param[in] B
*            B is REAL(*,*) array of DIMENSION (M,N) or (N,M)
*
* \param[in] LDB
*            LDB is INTEGER
...
*
* \param[in/out] C
*                C is REAL(*,*) array of DIMENSION (M,N) or (N,M)
*
* \param[in] LDC
*            LDC is INTEGER
*            The leading dimension of matrix C, should be at least max(1,M) or max(1,N) based on SIDE.
*
      SUBROUTINE SSPMM(SIDE,UPLO,TRAN,M,N,A,ALPHA,B,LDB,BETA,C,LDC)

      !...INPUT ARGUMENTS...
      CHARACTER SIDE,UPLO,TRAN
      INTEGER M,N,LDB,LDC
      REAL ALPHA,BETA,A(*),B(LDB,*),C(LDC,*)
