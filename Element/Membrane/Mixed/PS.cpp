...
std::vector<vec> PS::record(const OutputType P) {
    std::vector<vec> data;
...
vtkSmartPointer<vtkCell> PS::GetCell() const { return vtkSmartPointer<vtkQuad>::New(); }

mat PS::GetData(const OutputType P) {
