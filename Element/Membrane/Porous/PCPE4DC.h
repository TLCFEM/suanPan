...
/**
 * @class PCPE4DC
 * @brief The PCPE4 class handles CPE4 elements with pore pressure.
 *
 * @author tlc
 * @date 20/11/2021
 * @version 0.1.0
...
class PCPE4DC final : public MaterialElement2D {
    ...
    static constexpr unsigned m_node = 4, m_dof = 4, m_size = m_dof * m_node;
...
#ifdef SUANPAN_VTK
    vtkSmartPointer<vtkCell> Setup(const uvec&) override;
