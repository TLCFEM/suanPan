...
vtkSmartPointer<vtkCell> PCPE8UC::Setup(const uvec& encoding) const {
...
void PCPE8UC::GetData(vtkDoubleArray* const arrays, const OutputType type) {
...
void PCPE8UC::SetDeformation(vtkPoints* const nodes, const double amplifier) {
