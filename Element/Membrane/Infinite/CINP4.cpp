...
vtkSmartPointer<vtkCell> CINP4::Setup(const uvec& encoding) const {
...
void CINP4::GetData(vtkDoubleArray* const arrays, const OutputType type) {
...
void CINP4::SetDeformation(vtkPoints* const nodes, const double amplifier) {
