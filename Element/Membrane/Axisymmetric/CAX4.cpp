...
vtkSmartPointer<vtkCell> CAX4::Setup(const uvec& encoding) {
...
void CAX4::GetData(vtkDoubleArray* const arrays, const OutputType type) {
...
void CAX4::SetDeformation(vtkPoints* const nodes, const double amplifier) {
