...
vtkSmartPointer<vtkCell> CAX8::Setup(const uvec& encoding) const {
...
void CAX8::GetData(vtkDoubleArray* const arrays, const OutputType type) {
...
void CAX8::SetDeformation(vtkPoints* const nodes, const double amplifier) {
