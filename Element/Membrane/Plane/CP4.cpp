...
vtkSmartPointer<vtkCell> CP4::Setup(const uvec& encoding) const {
...
void CP4::GetData(vtkDoubleArray* const arrays, const OutputType type) {
...
void CP4::SetDeformation(vtkPoints* const nodes, const double amplifier) {
