...
vtkSmartPointer<vtkCell> C3D8I::Setup(const uvec& encoding) const {
...
void C3D8I::GetData(vtkDoubleArray* const arrays, const OutputType type) {
...
void C3D8I::SetDeformation(vtkPoints* const nodes, const double amplifier) {
