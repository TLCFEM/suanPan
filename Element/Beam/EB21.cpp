...
vtkSmartPointer<vtkCell> EB21::Setup(const uvec& encoding) const {
...
void EB21::GetData(vtkDoubleArray* const arrays, const OutputType type) {
...
void EB21::SetDeformation(vtkPoints* const nodes, const double amplifier) {
