...
vtkSmartPointer<vtkCell> B21H::Setup(const uvec& encoding) {
...
void B21H::GetData(vtkDoubleArray* const arrays, const OutputType type) {
...
void B21H::SetDeformation(vtkPoints* const nodes, const double amplifier) {
