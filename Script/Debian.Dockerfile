...
RUN apt-get update -y && apt-get install -y --no-install-recommends gcc g++ gfortran cmake git intel-oneapi-mkl-devel=2025.3.1 libxt-dev freeglut3-dev libxcursor-dev file dpkg-dev
