...
RUN dnf install -y libglvnd-devel gcc g++ gfortran rpm-build rpm-devel rpmdevtools cmake git intel-oneapi-mkl-devel=2025.3.1 intel-oneapi-mpi-devel procps-ng wget && dnf clean all
