...
int Material::update_incre_status(const double i_strain, const double i_strain_rate, const double i_strain_acc) {
	const vec i_vec_strain{i_strain};
	const vec i_vec_strain_rate{i_strain_rate};
	const vec i_vec_strain_acc{i_strain_acc};
	return update_incre_status(i_vec_strain, i_vec_strain_rate, i_vec_strain_acc);
...
int Material::update_trial_status(const double t_strain, const double t_strain_rate, const double t_strain_acc) {
	const vec t_vec_strain{t_strain};
	const vec t_vec_strain_rate{t_strain_rate};
	const vec t_vec_strain_acc{t_strain_acc};
	return update_trial_status(t_vec_strain, t_vec_strain_rate, t_vec_strain_acc);
}
