...
public:
    ...
    unique_ptr<Material> unique_copy() override { return std::make_unique<BilinearHoffman>(*this); }
};
...
public:
    ...
    unique_ptr<Material> unique_copy() override { return std::make_unique<BilinearTsaiWu>(*this); }
};
