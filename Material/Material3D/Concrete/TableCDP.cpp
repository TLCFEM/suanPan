...
TableCDP::TableCDP(const unsigned T, const double E, const double V, mat&& TT, mat&& CT, mat&& TDT, mat&& CDT, const double GT, const double GC, const double AP, const double BC, const double KC, const double S, const double R)
    : NonlinearCDP(T, E, V, GT, GC, AP, BC, KC, S, R)
    , t_table(std::move(TT))
    , c_table(std::move(CT))
