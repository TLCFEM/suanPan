...
\end{gather*}
where $D=A\left(\alpha^d-m-\mathbold{\alpha}:\mathbold{n}\right)$ is the dilatancy parameter, $A$ is a model constant, it can also be defined as a function of current state.
