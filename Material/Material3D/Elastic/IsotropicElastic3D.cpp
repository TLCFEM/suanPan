...
double IsotropicElastic3D::get_parameter(const ParameterType P) const {
...
void IsotropicElastic3D::print() { sp_info("A 3D isotropic elastic material with E={:.4E} and nu={:.4E}.\n", elastic_modulus, poissons_ratio); }
