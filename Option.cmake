...
if (COMPILER_IDENTIFIER MATCHES "vs")
    ...
    if (CMAKE_Fortran_COMPILER_ID MATCHES "IntelLLVM")
        set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -cpp -fiopenmp -w -fallow-argument-mismatch")
    else ()
        set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -cpp -fopenmp -w -fallow-argument-mismatch")
    endif ()
endif ()
