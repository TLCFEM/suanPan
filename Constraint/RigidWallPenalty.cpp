...
template<> void RigidWallPenalty::set_handler<DOF::U1>() {
...
template<> void RigidWallPenalty::set_handler<DOF::U1, DOF::U2>() {
...
template<> void RigidWallPenalty::set_handler<DOF::U1, DOF::U2, DOF::U3>() {
