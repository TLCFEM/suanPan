...
double NM3D3::compute_f(const vec& s, const double h) const { return compute_sf(s, h); }

vec NM3D3::compute_df(const vec& s, const double h) const { return compute_dsf(s, h); }

mat NM3D3::compute_ddf(const vec& s, const double h) const { return compute_ddsf(s, h); }
