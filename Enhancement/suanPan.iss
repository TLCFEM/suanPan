...
SetupIconFile=..\Resource\supan.ico
Compression=lzma
...
[Run]
Filename: "{app}\VC_redist.x64.exe"; Description: "Install Microsoft Visual C++ Redistributable for Visual Studio 2019"; Flags: postinstall skipifsilent
