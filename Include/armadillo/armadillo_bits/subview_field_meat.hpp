...
void subview_field<oT>::operator=(const field<oT>& x) {
	...
	if(t.n_slices == 1) { for(uword col = 0; col < t.n_cols; ++col) for(uword row = 0; row < t.n_rows; ++row) { t.at(row, col) = x.at(row, col); } }
	else {
		for(uword slice = 0; slice < t.n_slices; ++slice)
			for(uword col = 0; col < t.n_cols; ++col) for(uword row = 0; row < t.n_rows; ++row) { t.at(row, col, slice) = x.at(row, col, slice); }
	}
}
...
void subview_field<oT>::for_each(functor F) {
	...
	if(t.n_slices == 1) { for(uword col = 0; col < t.n_cols; ++col) for(uword row = 0; row < t.n_rows; ++row) { F(t.at(row, col)); } }
	else {
		for(uword slice = 0; slice < t.n_slices; ++slice)
			for(uword col = 0; col < t.n_cols; ++col) for(uword row = 0; row < t.n_rows; ++row) { F(t.at(row, col, slice)); }
	}
}
...
void subview_field<oT>::fill(const oT& x) {
	...
	if(t.n_slices == 1) { for(uword col = 0; col < t.n_cols; ++col) for(uword row = 0; row < t.n_rows; ++row) { t.at(row, col) = x; } }
	else {
		for(uword slice = 0; slice < t.n_slices; ++slice)
			for(uword col = 0; col < t.n_cols; ++col) for(uword row = 0; row < t.n_rows; ++row) { t.at(row, col, slice) = x; }
	}
}
...
void subview_field<oT>::extract(field<oT>& actual_out, const subview_field<oT>& in) {
	...
	if(n_slices == 1) { for(uword col = 0; col < n_cols; ++col) for(uword row = 0; row < n_rows; ++row) { out.at(row, col) = in.at(row, col); } }
	else {
		for(uword slice = 0; slice < n_slices; ++slice)
			for(uword col = 0; col < n_cols; ++col) for(uword row = 0; row < n_rows; ++row) { out.at(row, col, slice) = in.at(row, col, slice); }
	}
