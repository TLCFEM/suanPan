...
template<typename T1> inline
bool op_inv::apply_direct(Mat<typename T1::elem_type>& out, const Base<typename T1::elem_type, T1>& expr, const char* caller_sig) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool op_inv::apply_diagmat(Mat<typename T1::elem_type>& out, const T1& X, const char* caller_sig) {
	arma_extra_debug_sigprint();
...
inline
bool op_inv::apply_tiny_noalias(Mat<eT>& out, const Mat<eT>& X) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool op_inv_sympd::apply_direct(Mat<typename T1::elem_type>& out, const Base<typename T1::elem_type, T1>& expr) {
	arma_extra_debug_sigprint();
